...
const styles = {
  ...
  round:
    "inline-block text-sm rounded-full bg-stone-800 text-stone-100 font-semibold uppercase tracking-wide text-stone-800 transition-colors duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed px-2 py-0.5 md:px-2.5 md:py-1 text-sm",
  secondary:
